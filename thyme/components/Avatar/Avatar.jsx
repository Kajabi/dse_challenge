...
export const Avatar = ({
  ...
  const classNames = classnames(
    ...
    className,
    {
      'thyme-avatar--centered': centered,
      [`thyme-avatar--${color}`]: color,
    }
  );
  ...
  return (
    <div className={classNames} style={style} {...rest}>
      {badge && (
        <div className="thyme-avatar__badge">
          <Icon
      ...
      {image.src && (
        <img alt={image.alt || ''} className="thyme-avatar__image" src={image.src} id={image.id} />
      )}
      {lazyLoadInitials && (
        <svg className="thyme-avatar__initials" viewBox="0 0 32 32">
